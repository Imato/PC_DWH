...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [fact_2011], FILENAME = '$(DataPath)\fact_2012.ndf', SIZE = 15360 KB, FILEGROWTH = 10 %) TO FILEGROUP [fact_2011];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [fact_2013], FILENAME = '$(DataPath)\fact_2012.ndf', SIZE = 15360 KB, FILEGROWTH = 10 %) TO FILEGROUP [fact_2013];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [fact_2014], FILENAME = '$(DataPath)\fact_2012.ndf', SIZE = 15360 KB, FILEGROWTH = 10 %) TO FILEGROUP [fact_2014];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [fact_2015], FILENAME = '$(DataPath)\fact_2012.ndf', SIZE = 15360 KB, FILEGROWTH = 10 %) TO FILEGROUP [fact_2015];
