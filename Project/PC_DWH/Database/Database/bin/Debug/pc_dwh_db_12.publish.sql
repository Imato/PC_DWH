...
GO
PRINT N'Creating [dbo].[fact_sales_serial]...';


GO
ALTER TABLE [dbo].[fact_sales] WITH NOCHECK
    ADD CONSTRAINT [fact_sales_serial] FOREIGN KEY ([serial_id]) REFERENCES [dbo].[dim_serial] ([serial_id]);
...
ALTER TABLE [dbo].[fact_return] WITH CHECK CHECK CONSTRAINT [fact_returns_model];

ALTER TABLE [dbo].[fact_return] WITH CHECK CHECK CONSTRAINT [fact_return_customer];
...
ALTER TABLE [dbo].[fact_sales] WITH CHECK CHECK CONSTRAINT [fact_sales_serial];
