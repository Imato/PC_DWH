...
GO
PRINT N'Dropping [dbo].[fact_manufacture_hardware]...';


GO
ALTER TABLE [dbo].[fact_manufacture] DROP CONSTRAINT [fact_manufacture_hardware];


GO
PRINT N'Dropping [dbo].[fact_manufacture_supplier]...';


GO
ALTER TABLE [dbo].[fact_manufacture] DROP CONSTRAINT [fact_manufacture_supplier];


GO
PRINT N'Dropping [dbo].[fk_fact_manufacture_model]...';


GO
ALTER TABLE [dbo].[fact_manufacture] DROP CONSTRAINT [fk_fact_manufacture_model];


GO
PRINT N'Dropping [dbo].[fact_manufacture_purchase]...';


GO
ALTER TABLE [dbo].[fact_manufacture] DROP CONSTRAINT [fact_manufacture_purchase];


GO
PRINT N'Dropping [dbo].[fact_manufacture_serial]...';


GO
ALTER TABLE [dbo].[fact_manufacture] DROP CONSTRAINT [fact_manufacture_serial];
...
GO
PRINT N'Dropping [dbo].[fact_sales_serial]...';


GO
ALTER TABLE [dbo].[fact_sales] DROP CONSTRAINT [fact_sales_serial];
...
CREATE PARTITION FUNCTION [pf_id](INT)
    AS RANGE
    FOR VALUES (100000, 200000, 300000, 400000, 500000);
